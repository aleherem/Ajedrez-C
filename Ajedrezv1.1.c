...
int comprobar_caballo_rojo(char a[][8], char desde[5], char hasta[5], int i_inicial, int j_inicial, int i_final, int j_final);
int comprobar_caballo_azul(char a[][8], char desde[5], char hasta[5], int i_inicial, int j_inicial, int i_final, int j_final);

int comprobar_alfil_rojo(char a[][8], char desde[5], char hasta[5], int i_inicial, int j_inicial, int i_final, int j_final);
int comprobar_alfil_azul(char a[][8], char desde[5], char hasta[5], int i_inicial, int j_inicial, int i_final, int j_final);

int comprobar_torre_roja(char a[][8], char desde[5], char hasta[5], int i_inicial, int j_inicial, int i_final, int j_final);
int comprobar_torre_azul(char a[][8], char desde[5], char hasta[5], int i_inicial, int j_inicial, int i_final, int j_final);

int comprobar_peon_rojo(char a[][8], char desde[5], char hasta[5], int i_inicial, int j_inicial, int i_final, int j_final);
int comprobar_peon_azul(char a[][8], char desde[5], char hasta[5], int i_inicial, int j_inicial, int i_final, int j_final);

int comprobar_rey_rojo(char a[][8], char desde[5], char hasta[5], int i_inicial, int j_inicial, int i_final, int j_final);
int comprobar_rey_azul(char a[][8], char desde[5], char hasta[5], int i_inicial, int j_inicial, int i_final, int j_final);

int comprobar_dama_roja(char a[][8], char desde[5], char hasta[5], int i_inicial, int j_inicial, int i_final, int j_final);
int comprobar_dama_azul(char a[][8], char desde[5], char hasta[5], int i_inicial, int j_inicial, int i_final, int j_final);

int main(){
	
 // Coloca la consola para poder manejar la salida de los caracteres
...
if  (jugador == 1 && (isupper(a[j_inicial][i_inicial]))){
	switch (a[j_inicial][i_inicial]){
		...
		estado = comprobar_torre_roja(a, desde, hasta, i_inicial, j_inicial, i_final, j_final);
		if (estado == 1){
		...
		estado = comprobar_caballo_rojo(a, desde, hasta, i_inicial, j_inicial, i_final, j_final);
		if (estado == 1){
			printf("\t  Movimiento Invalido\n");
			goto destino;
		}
		...
		estado = comprobar_alfil_rojo(a, desde, hasta, i_inicial, j_inicial, i_final, j_final);
		if (estado == 1){
			printf("\t  Movimiento Invalido\n");
			goto destino;
		}
		...
		estado = comprobar_dama_roja(a, desde, hasta, i_inicial, j_inicial, i_final, j_final);
		if (estado == 1){
			printf("\t  Movimiento Invalido\n");
			goto destino;
		}
		...
		estado = comprobar_rey_rojo(a, desde, hasta, i_inicial, j_inicial, i_final, j_final);
		if (estado == 1){
			printf("\t  Movimiento Invalido\n");
			goto destino;
		}
		...
		estado = comprobar_peon_rojo(a, desde, hasta, i_inicial, j_inicial, i_final, j_final);
		if (estado == 1){
			printf("\t  Movimiento Invalido\n");
			goto destino;
		}
	...
	switch (a[j_inicial][i_inicial]){
		...
		estado = comprobar_torre_azul(a, desde, hasta, i_inicial, j_inicial, i_final, j_final);
		if (estado == 1){
			printf("\t  Movimiento Invalido\n");
			goto destino;
		}
		...
		estado = comprobar_caballo_azul(a, desde, hasta, i_inicial, j_inicial, i_final, j_final);
		if (estado == 1){
			printf("\t  Movimiento Invalido\n");
			goto destino;
		}
		...
		estado = comprobar_alfil_azul(a, desde, hasta, i_inicial, j_inicial, i_final, j_final);
		if (estado == 1){
			printf("\t  Movimiento Invalido\n");
			goto destino;
		}
		...
		estado = comprobar_dama_azul(a, desde, hasta, i_inicial, j_inicial, i_final, j_final);
		if (estado == 1){
			printf("\t  Movimiento Invalido\n");
			goto destino;
		}
		...
		estado = comprobar_rey_azul(a, desde, hasta, i_inicial, j_inicial, i_final, j_final);
		if (estado == 1){
			printf("\t  Movimiento Invalido\n");
			goto destino;
		}
		...
		estado = comprobar_peon_azul(a, desde, hasta, i_inicial, j_inicial, i_final, j_final);
		if (estado == 1){
			printf("\t  Movimiento Invalido\n");
			goto destino;
		}
...
int comprobar_caballo_azul(char a[][8], char desde[5], char hasta[5], int i_inicial, int j_inicial, int i_final, int j_final){
	...
	estado = 2;
		if (islower(a[j_final][i_final])){
			...
			if(a[j_final][i_final]== '-' || (isupper(a[j_final][i_final]))){
				if(((i_final == i_inicial + 1) && (j_final == j_inicial + 2)) ||
        			((i_final == i_inicial + 2) && (j_final == j_inicial + 1)) ||
        			((i_final == i_inicial - 1) && (j_final == j_inicial + 2)) ||
        			((i_final == i_inicial - 2) && (j_final == j_inicial + 1)) ||
...
int comprobar_peon_azul(char a[][8], char desde[5], char hasta[5], int i_inicial, int j_inicial, int i_final, int j_final){
	...
	estado = 1;
			if (islower(a[j_final][i_final])){
				...
				if(j_inicial==6 && (i_inicial>=0 || i_inicial<=7) && i_inicial == i_final && j_final == j_inicial - 2){
					estado = 2;		
				}	
				if(i_final == i_inicial && j_final == j_inicial - 1 && a[j_final][i_final]=='-'){
					estado = 2;
...
int comprobar_dama_roja(char a[][8], char desde[5], char hasta[5], int i_inicial, int j_inicial, int i_final, int j_final){
	...
	mov_torre = comprobar_torre_roja(a, desde, hasta, i_inicial, j_inicial, i_final, j_final);
	mov_alfil = comprobar_alfil_rojo(a, desde, hasta, i_inicial, j_inicial, i_final, j_final);
...
int comprobar_dama_azul(char a[][8], char desde[5], char hasta[5], int i_inicial, int j_inicial, int i_final, int j_final){
	...
	mov_torre = comprobar_torre_azul(a, desde, hasta, i_inicial, j_inicial, i_final, j_final);
	mov_alfil = comprobar_alfil_azul(a, desde, hasta, i_inicial, j_inicial, i_final, j_final);
